...
-spec get_limits(invoice_id(), payment_id(), pid()) -> [turnover_limit()] | woody_error:business_error().
get_limits(InvoiceID, PaymentID, Client) ->
    map_result_error(gen_server:call(Client, {call, 'GetLimits', [InvoiceID, PaymentID]})).
