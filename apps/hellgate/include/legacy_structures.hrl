...
-define(legacy_payment_started(Payment, RiskScore, Route, Cashflow),
    {invoice_payment_started, {payproc_InvoicePaymentStarted, Payment, RiskScore, Route, Cashflow}}
).

-define(legacy_payment_status_changed(Status),
    {invoice_payment_status_changed, {payproc_InvoicePaymentStatusChanged, Status}}
).

-define(legacy_session_ev(Target, Payload),
    {invoice_payment_session_change, {payproc_InvoicePaymentSessionChange, Target, Payload}}
).

-define(legacy_adjustment_ev(AdjustmentID, Payload),
    {invoice_payment_adjustment_change, {payproc_InvoicePaymentAdjustmentChange, AdjustmentID, Payload}}
).
...
-define(legacy_session_started(),
    {invoice_payment_session_started, {payproc_InvoicePaymentSessionStarted}}
).

-define(legacy_session_finished(Result),
    {invoice_payment_session_finished, {payproc_InvoicePaymentSessionFinished, Result}}
).

-define(legacy_session_suspended(),
    {invoice_payment_session_suspended, {payproc_InvoicePaymentSessionSuspended}}
).

-define(legacy_session_activated(),
    {invoice_payment_session_activated, {payproc_InvoicePaymentSessionActivated}}
).

-define(legacy_trx_bound(Trx),
    {invoice_payment_session_transaction_bound, {payproc_InvoicePaymentSessionTransactionBound, Trx}}
).

-define(legacy_proxy_st_changed(ProxySt),
    {invoice_payment_session_proxy_state_changed, {payproc_InvoicePaymentSessionProxyStateChanged, ProxySt}}
).
...
-define(legacy_adjustment_created(Adjustment),
    {invoice_payment_adjustment_created, {payproc_InvoicePaymentAdjustmentCreated, Adjustment}}
).

-define(legacy_adjustment_status_changed(Status),
    {invoice_payment_adjustment_status_changed, {payproc_InvoicePaymentAdjustmentStatusChanged, Status}}
).
