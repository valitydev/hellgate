...
-spec construct_routing_delegate(_RuleSetRef, _Predicate) -> dmsl_domain_thrift:'PaymentRoutingDelegate'().
...
-spec construct_routing_candidate(_, _) -> dmsl_domain_thrift:'PaymentRoutingCandidate'().
