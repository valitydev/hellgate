...
handle_function(
    ...
    {ok, [
        #fault_detector_ServiceStatistics{
            service_id = <<"hellgate_service.provider_conversion.11">>,
            failure_rate = 0.9,
            operations_count = 10,
        ...
        #fault_detector_ServiceStatistics{
            service_id = <<"hellgate_service.provider_conversion.12">>,
            failure_rate = 0.1,
            operations_count = 10,
        ...
        #fault_detector_ServiceStatistics{
            service_id = <<"hellgate_service.adapter_availability.11">>,
            failure_rate = 0.9,
            operations_count = 10,
            error_operations_count = 9,
            overtime_operations_count = 0,
        ...
        #fault_detector_ServiceStatistics{
            service_id = <<"hellgate_service.adapter_availability.12">>,
            failure_rate = 0.1,
            operations_count = 10,
            error_operations_count = 1,
            overtime_operations_count = 0,
